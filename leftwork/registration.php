...
<body bgcolor="">
    ...
    <form action="" method="post">
        <table width="30%" bgcolor="" border="1" cellspacing="0" cellpadding="25" align="center" bordercolor="">
            <tr>
                <td>
                    <font color="" face="times new roman" size="6">Create Account</font>
                    <br><br>
                    <font color="" face="times new roman" size="4">Full Name</font>
                    <br>
                    ...
                    <br><br>
                    <font color="" face="times new roman" size="4">Username</font>
                    <br>
                    ...
                    <br><br>
                    <font color="" face="times new roman" size="4">Phone number</font>
                    <br>
                    ...
                    <br><br>
                    <font color="" face="times new roman" size="4">Email</font>
                    <br>
                    ...
                    <br><br>
                    <font color="" face="times new roman" size="4">Password</font>
                    <br>
                    ...
                    <br><br>
                    <font color="" face="times new roman" size="2"><i>i &nbsp;</i></font><font color="" face="times new roman" size="2">Passwords must be at least 8 characters.</font>
                    <br><br>
                    <font color="" face="times new roman" size="4">Re-enter password</font>
                    <br>
                    ...
                    <br><br>
                    <!-- <input type="checkbox" name="termsandconditions" required> <font color="white" face="times new roman" size="4">I accept the Terms and Conditions</font><br><br><br> -->
                    <button size="250px" name="submit" id="submitButton" >Create your iMBD account</button>
                    <br><br>
                    <hr color="" width="auto">
                    <p align="center">
                        <br>
                        <font color="" face="times new roman" size="3">Already have an account?</font>
                        <a href="sign-in.html"><font color="" face="times new roman" size="3">Sign in</font></a>
                    </p>
                </td>
            </tr>
        </table>
